...
export class ApiService {
  ...
  reject: any;
  InternetAvail: any;
  public homeCategory:any = [];
  getApiUrl : string = "http://rinstructor.truetechpro.com/wp-json/wp/v2/";
  private API_URL_NEW = 'http://rinstructor.truetechpro.com/wp-json/wp/v2/';
...
howWorkshomePages(){
 ...
 //  return  this.http.get(this.getApiUrl).map((res : Response ) => res.json())    .catch(error => console.log(error));
    ...
    homePages(forceRefresh: boolean = false): Observable<any[]> {
