...
const routes = [
    ...
    {
        path: 'posts',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-posts-posts-module */ "pages-posts-posts-module").then(__webpack_require__.bind(null, /*! ./pages/posts/posts.module */ "./src/app/pages/posts/posts.module.ts")).then(m => m.PostsPageModule)
    },
    {
        path: 'subcategory/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-subcategory-subcategory-module */ "pages-subcategory-subcategory-module").then(__webpack_require__.bind(null, /*! ./pages/subcategory/subcategory.module */ "./src/app/pages/subcategory/subcategory.module.ts")).then(m => m.SubcategoryPageModule)
    },
    {
        path: 'postdetail/:postId',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-postdetail-postdetail-module */ "pages-postdetail-postdetail-module").then(__webpack_require__.bind(null, /*! ./pages/postdetail/postdetail.module */ "./src/app/pages/postdetail/postdetail.module.ts")).then(m => m.PostdetailPageModule)
    },
    {
        path: 'videopost/:postId',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-videopost-videopost-module */ "pages-videopost-videopost-module").then(__webpack_require__.bind(null, /*! ./pages/videopost/videopost.module */ "./src/app/pages/videopost/videopost.module.ts")).then(m => m.VideopostPageModule)
    },
    {
        path: 'video',
    ...
    {
        path: 'whichtest',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-whichtest-whichtest-module */ "pages-whichtest-whichtest-module").then(__webpack_require__.bind(null, /*! ./pages/whichtest/whichtest.module */ "./src/app/pages/whichtest/whichtest.module.ts")).then(m => m.WhichtestPageModule)
    },
    {
        path: 'contact',
    ...
    {
        path: 'cheatsheets',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-cheatsheets-cheatsheets-module */ "pages-cheatsheets-cheatsheets-module").then(__webpack_require__.bind(null, /*! ./pages/cheatsheets/cheatsheets.module */ "./src/app/pages/cheatsheets/cheatsheets.module.ts")).then(m => m.CheatsheetsPageModule)
    },
    {
...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        ...
        setTimeout(function () {
            jquery__WEBPACK_IMPORTED_MODULE_10__('.footInner ion-toolbar').eq(0).trigger('click');
        }, 1000);
...
/* harmony import */ var _providers_apiservice__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../providers/apiservice */ "./src/providers/apiservice.ts");
...
/* harmony import */ var _ionic_native_app_availability_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ionic-native/app-availability/ngx */ "./node_modules/@ionic-native/app-availability/ngx/index.js");
/* harmony import */ var _ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @ionic-native/device/ngx */ "./node_modules/@ionic-native/device/ngx/index.js");
/* harmony import */ var _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ionic-native/file-transfer/ngx */ "./node_modules/@ionic-native/file-transfer/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _providers_apiservice__WEBPACK_IMPORTED_MODULE_13__["Apiservice"],
            ...
            _ionic_native_app_availability_ngx__WEBPACK_IMPORTED_MODULE_19__["AppAvailability"],
...
let OfflineManagerService = class OfflineManagerService {
    ...
    checkForEvents() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.storage.get(STORAGE_REQ_KEY)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(storedOperations => {
            let storedObj = JSON.parse(storedOperations);
            if (storedObj && storedObj.length > 0) {
                return this.sendRequests(storedObj).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => {
                    let toast = this.toastController.create({
...
module.exports = __webpack_require__(/*! /Users/krishna/Documents/chandan/10_06_2020/RInsteructorTestingContactNew/src/main.ts */"./src/main.ts");
