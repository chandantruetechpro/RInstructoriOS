...
/* harmony import */ var _index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-8ac363fb.js */ "./node_modules/@ionic/core/dist/esm/index-8ac363fb.js");
...
const animateBackButton = (rootAnimation, rtl, backDirection, backButtonEl, largeTitleBox, backButtonBox) => {
    ...
    const enteringBackButtonTextAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
    const enteringBackButtonIconAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
...
const animateLargeTitle = (rootAnimation, rtl, backDirection, largeTitleEl, largeTitleBox, backButtonBox) => {
    ...
    const clonedLargeTitleAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
...
const iosTransitionAnimation = (navEl, opts) => {
    try {
        ...
        const rootAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
        const enteringContentAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
        rootAnimation
        ...
        if (leavingEl && navEl) {
            const navDecorAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
        ...
        if (contentEl) {
            ...
            if (enteringTransitionEffectEl) {
                ...
                const enteringTransitionEffect = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                const enteringTransitionCover = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                const enteringTransitionShadow = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
        ...
        enteringToolBarEls.forEach(enteringToolBarEl => {
            ...
            const enteringTitle = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            enteringTitle.addElement(enteringToolBarEl.querySelector('ion-title')); // REVIEW
            const enteringToolBarButtons = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            ...
            const enteringToolBarItems = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            enteringToolBarItems.addElement(enteringToolBarEl.querySelectorAll(':scope > *:not(ion-title):not(ion-buttons):not([menuToggle])'));
            const enteringToolBarBg = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            enteringToolBarBg.addElement(shadow(enteringToolBarEl).querySelector('.toolbar-background')); // REVIEW
            const enteringBackButton = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            ...
            if (backDirection) {
                ...
                const translucentHeader = (_a = parentHeader) === null || _a === void 0 ? void 0 : _a.translucent;
                ...
                if (backButtonEl && !forward) {
                    const enteringBackBtnText = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                    enteringBackBtnText
        ...
        // setup leaving view
        if (leavingEl) {
            const leavingContent = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            ...
            if (backDirection) {
                ...
                const leavingPage = Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_5__["g"])(leavingEl);
            ...
            if (leavingContentEl) {
                ...
                if (leavingTransitionEffectEl) {
                    ...
                    const leavingTransitionEffect = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                    const leavingTransitionCover = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                    const leavingTransitionShadow = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
            ...
            leavingToolBarEls.forEach(leavingToolBarEl => {
                var _a;
                const leavingToolBar = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                leavingToolBar.addElement(leavingToolBarEl);
                const leavingTitle = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                leavingTitle.addElement(leavingToolBarEl.querySelector('ion-title')); // REVIEW
                const leavingToolBarButtons = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                ...
                const leavingToolBarItems = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                const leavingToolBarItemEls = leavingToolBarEl.querySelectorAll(':scope > *:not(ion-title):not(ion-buttons):not([menuToggle])');
                if (leavingToolBarItemEls.length > 0) {
                    leavingToolBarItems.addElement(leavingToolBarItemEls);
                }
                const leavingToolBarBg = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                leavingToolBarBg.addElement(shadow(leavingToolBarEl).querySelector('.toolbar-background')); // REVIEW
                const leavingBackButton = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                ...
                if (backDirection) {
                    ...
                    if (backButtonEl && !backward) {
                        const leavingBackBtnText = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
                        leavingBackBtnText
                            .addElement(shadow(backButtonEl).querySelector('.button-text')) // REVIEW
...
//# sourceMappingURL=ios-transition-098458fb-js-es2015.js.map