...
var VideoPage = /** @class */ (function () {
    function VideoPage(apiservice, plt, networkService, storage, offlineManager, loadingCtrl, navCtrl, router) {
    ...
    VideoPage.prototype.showHide = function () {
    ...
    VideoPage.prototype.OnInput = function (event) {
        var self = this;
        this.navCtrl.navigateForward(['search/' + event.target.value]);
        self.show = false;
    };
    VideoPage.prototype.submitdata = function (formValue) {
    ...
    VideoPage.prototype.homeListing = function (refresh) {
        ...
        if (this.networkService.getCurrentNetworkStatus() == _providers_network__WEBPACK_IMPORTED_MODULE_4__["ConnectionStatus"].Offline) {
            ...
            this.storage.get('VideoPageSQLite').then(function (val) {
                ...
                var o = 1;
                var z = 0;
                console.log('this.ArrangeCategory ==> ' + JSON.stringify(_this.result));
                for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                    var CatData = _a[_i];
                    _this.ArrangeCategory = CatData.data;
                ...
                console.log('this.ArrangeCategory22222 ==> ' + JSON.stringify(_this.ArrangeCategory));
                // let o = 1;
                // for (let CatData of this.result) {
                //   this.categories = CatData.data;
        ...
        if (this.networkService.getCurrentNetworkStatus() == _providers_network__WEBPACK_IMPORTED_MODULE_4__["ConnectionStatus"].Offline) {
            ...
            this.apiservice.VideoData().then(function (res) {
                ...
                setTimeout(function () {
                    ...
                    console.log('ArrangeCategory' + JSON.stringify(self_1.ArrangeCategory));
                }, 200);
                if (refresher) {
                    refresher.target.complete();
                    //this.LoaderShow = false;
