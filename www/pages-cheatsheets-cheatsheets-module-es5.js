...
var CheatsheetsPage = /** @class */ (function () {
    ...
    CheatsheetsPage.prototype.showHide = function () {
    ...
    CheatsheetsPage.prototype.OnInput = function (event) {
        var self = this;
        this.navCtrl.navigateForward(['search/' + event.target.value]);
        self.show = false;
    };
    CheatsheetsPage.prototype.submitdata = function (formValue) {
        ...
        if (this.networkService.getCurrentNetworkStatus() == _providers_network__WEBPACK_IMPORTED_MODULE_4__["ConnectionStatus"].Offline) {
            this.storage.get('CheatSheetPageSQLite').then(function (val) {
                ...
                for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                    var subCatLoop = _a[_i];
                    _this.SubCategories = subCatLoop.data;
                    ...
                    _this.CategoryData = subCatLoop.category_data;
                    ...
                    for (var _d = 0, _e = _this.SubCategories; _d < _e.length; _d++) {
                        var SubCats = _e[_d];
    ...
    CheatsheetsPage.prototype.loadData = function (refresh, refresher) {
        ...
        if (this.networkService.getCurrentNetworkStatus() == _providers_network__WEBPACK_IMPORTED_MODULE_4__["ConnectionStatus"].Offline) {
            ...
            this.apiservice.HomeCategory(79).then(function (res) {
